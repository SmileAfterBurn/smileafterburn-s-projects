...
export const INITIAL_ORGANIZATIONS: Organization[] = [
  ...
  {
    id: 'csv_mk_shelter_1',
    name: 'Тимчасовий притулок (Кризовий центр)',
    address: 'м. Миколаїв',
    lat: 46.9753,
    lng: 31.9946,
    category: 'Притулок',
  ...
  {
    id: 'csv_mk_coord_1',
    name: 'Координаційний центр допомоги',
    address: 'Миколаївська область',
    lat: 47.5672,
    lng: 31.3334,
    category: 'Координація',
