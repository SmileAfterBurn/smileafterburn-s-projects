  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'welcome',
      role: 'model',
      text: 'Вітаю вас! Я пані Думка, ваша помічниця. Я можу знайти для вас контакти допомоги, розповісти про послуги або підказати, куди звернутися у вашому регіоні.',
      timestamp: Date.now()
    }
  ]);
