...
const SLIDES = [
  {
    ...
    text: "Ми об'єднали понад 20 регіонів України в єдину мережу допомоги. Знаходьте перевірені благодійні фонди, державні соцслужби, шелтери та гуманітарні штаби у своєму місті.",
  },
  {
