...
const SLIDES = [
  {
    title: "Вітаємо на оновленій Мапі послуг!",
    text: "Ми розширилися! Тепер мапа охоплює Одеську, Миколаївську, Херсонську, а також Дніпропетровську та Запорізьку області. Знаходьте перевірені благодійні фонди та державні служби поруч.",
  },
  {
  ...
  },
  {
    ...
    text: "Спілкуйтеся голосом! Натисніть мікрофон у чаті «Помічниця», і пані Думка знайде для вас контакти, розповість про бюджет організацій та допоможе скласти маршрут допомоги.",
  },
  {
    title: "Почнімо роботу",
    text: "Оберіть свій регіон зі списку — ми автоматично налаштуємо мапу та покажемо найближчі до вас пункти видачі допомоги та шелтери.",
  }
];
