...
const SLIDES = [
  {
    title: "Вітаємо на Всеукраїнській Мапі послуг!",
    text: "Ми значно розширилися! Тепер мапа охоплює майже всю Україну: Київ, Львів, Харків, Тернопіль, Чернівці, Хмельницький, Чернігів та інші регіони. Знаходьте муніципальні центри, Карітаси та перевірені фонди поруч.",
  },
  {
    title: "Дистанційна підтримка",
    text: "Нова функція! Натисніть кнопку «Дистанційна підтримка», щоб миттєво знайти телефони гарячих ліній, психологічну допомогу онлайн та юридичні консультації, доступні з будь-якої точки.",
  },
  {
    title: "Голосова помічниця пані Думка",
    text: "Спілкуйтеся голосом! Натисніть мікрофон у чаті «Помічниця», і пані Думка знайде для вас контакти, графік роботи соцзахисту та допоможе скласти маршрут допомоги.",
  },
  {
    title: "Почнімо роботу",
    text: "Оберіть свій регіон зі списку — ми автоматично налаштуємо мапу та покажемо найближчі до вас пункти допомоги.",
  }
];
